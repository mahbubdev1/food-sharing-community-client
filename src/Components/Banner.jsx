                        ...
                        <SwiperSlide>
                            <div className="relative">
                                ...
                                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center text-white">
                                    ...
                                    <Link to="/availableFoods" className="btn mt-4 px-8 py-3 bg-violet-400 text-lg font-bold rounded-md hover:bg-violet-500">View More</Link>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="relative">
                                ...
                                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-white">
                                    ...
                                    <Link to="/availableFoods" className="btn mt-4 px-8 py-3 bg-violet-400 text-base font-bold rounded-md hover:bg-violet-500">View More</Link>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
