        ...
        <div className="container mx-auto mt-24">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10'>
                <div className='group border border-gray-200 rounded-lg shadow-md'>
                    ...
                    <div className='w-32 mx-auto group-hover:w-full duration-500 h-1 mt-5 transition-all bg-violet-500'></div>
                </div>
                <div className='group border border-gray-200 rounded-lg shadow-md'>
                    <img src={blog2} alt="" />
                    <div className='p-2'>
                    ...
                    <div className='w-32 mx-auto group-hover:w-full h-1 duration-500 mt-5 transition-all bg-violet-500'></div>
                </div>
                <div className='group border border-gray-200 rounded-lg shadow-md'>
                    <img src={blog3} alt="" />
                    <div className='p-2'>
                    ...
                    <div className='w-32 mx-auto group-hover:w-full h-1 mt-5 duration-500 transition-all bg-violet-500'></div>
                </div>
            </div>
        </div>
    );
